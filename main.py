...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # upsample
    l7_out = tf.layers.conv2d_transpose(conv_1x1_l7,
                                        num_classes,
                                        kernel_size=4,
                                        strides=2,
                                        padding='same',
    ...
    l4_plus_l7 = tf.add(l7_out, conv_1x1_l4)

    # upsample
    output = tf.layers.conv2d_transpose(l4_plus_l7,
                                        num_classes,
                                        kernel_size=4,
                                        strides=2,
                                        padding='same',
...
def run():
    ...
    with tf.Session() as sess:
        ...
        helper.save_inference_samples_video(runs_dir, sess, image_shape, logits, keep_prob, input_image)
        # save model 
